...
"""Dexterity drafts related interfaces
"""

class IDexterityDraftable(Interface):
    """Custom marker interface to identify dexterity objects since dexterity
    does not initate own event notifiers and uses ones like
    zope.app.container.interfaces.IObjectAddedEvent.  This way we won't
    receive events from other objects by accident.
    """
    
class IDexterityDraft(Interface):
    """Marker interface to identify the object is a draft for a dexterity
    object
    """
    
    
# MOVE TO PREVIEW PACKAGE
class IDexterityDraftItem(Interface):
    """Marker interface to identify its a draft object of Item
    """

# MOVE TO PREVIEW PACKAGE
class IDexterityDraftContainer(Interface):
    """Marker interface to identify its a draft object of Container
    """

# MOVE TO PREVIEW PACKAGE
class IDexterityDraftAdding(Interface):
    """Marker interface to indicate draft was created by add form
    """
    
# MOVE TO PREVIEW PACKAGE
class IDexterityDraftEditing(Interface):
    """Marker interface to indicate draft was created by edit form
    """
    
# MOVE TO PREVIEW PACKAGE
class IDefaultPreview(Interface):
    """Marker interface used to mark the preview view so recurrsion will not
    happen when looking up views to use for preview view
    """
